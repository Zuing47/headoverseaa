  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.25) 0%, rgba(0,0,0,0.15) 45%, rgba(0,0,0,0.62) 100%)",
        }}
      />
      <div
      ...
      />
      <div className="page-shell relative z-10 flex min-h-[min(70vh,640px)] flex-col justify-end py-14 md:min-h-[80vh] md:justify-center md:py-20">
        <Reveal variant="rise">
        ...
        <Reveal delay={0.14} variant="rise">
          <p className="font-display mt-8 max-w-2xl text-[clamp(2.1rem,4.2vw,3.5rem)] leading-[1.08]">
            {en
        ...
        <Reveal delay={0.24} variant="fadeUp">
          <p className="mt-6 max-w-[38ch] text-[15px] leading-relaxed text-white/50 md:text-[16px]">
            {en
